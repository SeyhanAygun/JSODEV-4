...
let kahvaltiUrunleri=["zeytin","25","reçel","17","bal","32"];
let araUrunleri=["ceviz","21","erik","11","badem","25"];
let icecekUrunleri=["çay","39","şalgam","10","ayran","5"];
...
function urunleriGetir(){
    ...
    if(document.getElementById("kategoriKahvalti").checked)
    {
        for(i=0;i<kahvaltiUrunleri.length;i=i+2)
        {
            olustur();
            urunSecenek.value=kahvaltiUrunleri[i+1];
            urunAciklama.innerHTML=kahvaltiUrunleri[i]; 
        }
    }
    else if(document.getElementById("kategoriAra").checked)
    {
        for(i=0;i<araUrunleri.length;i=i+2)
        {
        olustur();
        urunSecenek.value=araUrunleri[i+1];
        urunAciklama.innerHTML=araUrunleri[i];
        }
    }
    else if(document.getElementById("kategoriIcecek").checked)
    {
        for(i=0;i<icecekUrunleri.length;i=i+2)
        {
        olustur();
        urunSecenek.value=icecekUrunleri[i+1];
        urunAciklama.innerHTML=icecekUrunleri[i];
        }
    }
}
